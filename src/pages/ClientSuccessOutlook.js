...
import styles from "./ClientSuccessOutlook.module.css";

const ClientSuccessOutlook = () => {
  return (
    <div className={styles.clientSuccessOutlook}>
      <Sidebar
        vector="/vector.svg"
        vector1="/vector1.svg"
...
export default ClientSuccessOutlook;
